...
class NetworkParser {
  ...
  // be made available for end users
     ...
     * some tabulated data
     * @param delimiter the delimiter that seperates the column of energy values and xsec/rate values in the file
     * This function will exit the program if the delimiter is an empty string or if it contains numbers
     */
    ...
    // we do not let users to perform a simulation with errors in the network or with lack of documentation
    /**
     ...
     */
    const std::vector<std::shared_ptr<const Reaction>> & getTabulatedXSecReactions() const {preventInvalidDataFetch(); return _tabulated_xsec_based;}
    /**
     * Gets all of the reactions in the xsec-based block
     ...
     * @returns a vector of shared_ptr for all of the reactions of this type
     */
    const std::vector<std::shared_ptr<const Reaction>> & getFunctionXSecReactions() const {preventInvalidDataFetch(); return _function_xsec_based;}
    /**
     * Gets all of the reactions in the xsec-based block
     ...
     * @returns a vector of shared_ptr for all of the reactions of this type
     */
    const std::vector<std::shared_ptr<const Reaction>> & getTabulatedRateReactions() const {preventInvalidDataFetch(); return _tabulated_rate_based;}
    /**
     * Gets all of the reactions in the xsec-based block
     ...
     * @returns a vector of shared_ptr for all of the reactions of this type
     */
    const std::vector<std::shared_ptr<const Reaction>> & getFunctionRateReactions() const {preventInvalidDataFetch(); return _function_rate_based;}
    /**
     ...
     */
    const std::vector<std::shared_ptr<const Species>> & getSpecies() const {preventInvalidDataFetch(); return _species;}
