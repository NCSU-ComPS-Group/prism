...
const std::vector<std::string> allowed_reaction_params = {REACTION_KEY, DELTA_EPS_E_KEY, DELTA_EPS_G_KEY, ELASTIC_KEY, NOTE_KEY, REFERENCE_KEY, FILE_KEY, PARAM_KEY};
