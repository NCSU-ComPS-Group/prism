...
const std::vector<const std::string> allowed_network_inputs = {BIB_KEY, PATH_KEY, RATE_BASED, XSEC_BASED, LATEX_OVERRIDES, CUSTOM_SPECIES, LUMPED_SPECIES};
/// input keys for the custom species block
const std::string NAME_KEY = "name";
const std::string MASS_KEY = "mass";
const std::vector<const std::string> allowed_custom_params = {NAME_KEY, MASS_KEY};
/// input keys for lumping block
const std::string LUMPED_KEY  = "lumped";
const std::string ACTUAL_KEY = "actual";
const std::vector<const std::string> allowed_lumped_params = {LUMPED_KEY, ACTUAL_KEY};
/// inputs keys for latex overrides
const std::string SPECIES_KEY = "species";
const std::string LATEX_KEY =  "latex";
const std::vector<const std::string> allowed_latex_override_params = {SPECIES_KEY, LATEX_KEY};
...
const std::vector<const std::string> allowed_reaction_params = {REACTION_KEY, DELTA_EPS_E_KEY, DELTA_EPS_G_KEY, ELASTIC_KEY, NOTE_KEY, REFERENCE_KEY, FILE_KEY, PARAM_KEY};
